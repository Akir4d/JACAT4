...
define('JACAT_VERSION',		'Build 20220219');	// will follow semantic version (e.g. v1.x.x) after first stable launch

/* OLD FILES COMPATIBILIY*/
defined('BASEPATH')      || define('BASEPATH', ''); // highest automatically-assigned error code
